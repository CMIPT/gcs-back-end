...
COMMENT ON COLUMN public.t_activity_comment.creator_id IS 'ID of the user who posted this comment.';
...
COMMENT ON COLUMN public.t_activity_comment.modifier_id IS 'ID of the user who last modified this comment. NULL if not modified.';
