...
public class ActivityControllerTest {
    ...
    @BeforeAll
    public void init() {
        activityCreator = (accessToken, activityDTO) -> {
            try {
                mvc.perform(
        ...
        activityPager = (accessToken, activityQueryDTO) -> {
            try {
                ...
                if (repositoryId.equals(TestConstant.REPOSITORY_ID)) {
                    ...
                    TestConstant.REPOSITORY_DELETE_ACTIVITY_ID = pageVO.records().get(1).id();
                    ...
                    TestConstant.OTHER_PRIVATE_REPOSITORY_ACTIVITY_NUMBER = pageVO.records().get(0).number();
    ...
    public void testCreateActivityValid() throws Exception {
        ...
        String activityQueryDTO = """
                ...
                """.formatted(TestConstant.USERNAME,
        ...
        var otherActivityQueryDTO = """
                ...
                """.formatted(TestConstant.OTHER_USERNAME,
                UserQueryTypeEnum.USERNAME.name(),
        ...
        var result3 = activityPager.apply(TestConstant.OTHER_ACCESS_TOKEN, otherPrivateActivityQueryDTO);
        if (result3 != null) {
            throw result3;
        }
    }
    ...
    public void testPageActivityValid() throws Exception {
        var result = activityPager.apply(TestConstant.ACCESS_TOKEN, """
                {
                    "user": "%s",
                    "userType":"%s",
                    "repositoryId": "%s",
        ...
        mvc.perform(
                        post(ApiPathConstant.ACTIVITY_UPDATE_ACTIVITY_API_PATH)
                                ...
                                .content("""
                                        ...
                                        """.formatted(TestConstant.OTHER_PRIVATE_REPOSITORY_ACTIVITY_ID, newDescription)))
        ...
        mvc.perform(
                        post(ApiPathConstant.ACTIVITY_CREATE_COMMENT_API_PATH)
                                ...
                                .content("""
                                        ...
                                        """.formatted(TestConstant.REPOSITORY_ACTIVITY_ID, TestConstant.COMMENT_CONTENT)))
                .andExpectAll(status().isOk());
        ...
        mvc.perform(
                        post(ApiPathConstant.ACTIVITY_CREATE_COMMENT_API_PATH)
                                ...
                                .content("""
                                        ...
                                        """.formatted(TestConstant.REPOSITORY_DELETE_ACTIVITY_ID, TestConstant.COMMENT_CONTENT)))
                .andExpectAll(status().isOk());
    }
        ...
        mvc.perform(
                        post(ApiPathConstant.ACTIVITY_CREATE_COMMENT_API_PATH)
                                ...
                                .content("""
                                        ...
                                        """.formatted(TestConstant.OTHER_PRIVATE_REPOSITORY_ACTIVITY_ID, TestConstant.COMMENT_CONTENT)))
                .andExpectAll(status().isNotFound());
    ...
    public void testDeleteActivityValid() throws Exception {
        ...
        long labelCnt = activityAssignLabelService.count(
                new QueryWrapper<ActivityAssignLabelPO>()
                        .eq("activity_id", Long.valueOf(TestConstant.REPOSITORY_DELETE_ACTIVITY_ID))
        );
        long assigneeCnt = activityDesignateAssigneeService.count(
