...
public class GlobalExceptionHandler {
   ...
   *
   * <p>This method is used to handle the MethodArgumentNotValidException, which is thrown when the
   ...
   *
   * <p>This method is used to handle the HttpMessageNotReadableException, which is thrown when the
   * request body is not readable. For example, when the request body is not a valid JSON.
   */
   ...
   *
   * <p>This method is used to handle the JsonParseException, which is thrown when the JSON parsing
   * fails.
   */
