...
@Service
public class ActivityAssignLabelServiceImpl extends ServiceImpl<ActivityAssignLabelMapper, ActivityAssignLabelPO> implements ActivityAssignLabelService{
        ...
        var queryWrapper =
                JoinWrappers.lambda(ActivityAssignLabelPO.class)
                        ...
                        .innerJoin(
                                LabelPO.class,
                                LabelPO::getId,
                                ActivityAssignLabelPO::getLabelId)
                        .in(ActivityAssignLabelPO::getActivityId, activityIds);
        List<ActivityOwnLabelDTO> activityAssignLabelPOS = activityAssignLabelMapper.selectJoinList(ActivityOwnLabelDTO.class,
                queryWrapper);
    ...
    @Override
    public Page<ActivityAssignLabelDTO> pageActivityLabelsByActivityId(Long activityId, Page<ActivityAssignLabelDTO> Page) {
        var queryWrapper =
                JoinWrappers.lambda(ActivityAssignLabelPO.class)
