...
public record CommentFullInfoVO(
    ...
    @Schema(description = "Username of the comment author") String username,
    @Schema(description = "Email of the comment author") String email,
    @Schema(description = "Avatar URL of the comment author") String avatarUrl,
  ...
  public CommentFullInfoVO(CommentFullInfoDTO commentFullInfoDTO) {
    this(
        ...
        commentFullInfoDTO.getUserId().toString(),
        commentFullInfoDTO.getUsername(),
        commentFullInfoDTO.getEmail(),
        commentFullInfoDTO.getAvatarUrl(),
