...
public record ActivityQueryDTO(
    ...
    @Schema(description = "Repository ID", example = "11") @NotNull(groups = QueryGroup.class)
        String repositoryId,
    @Schema(description = "Author of the Activity", example = "author123") String author,
    @Schema(description = "is the Activity a Pull Request?", example = "true")
        @NotNull(groups = QueryGroup.class)
        Boolean isPullRequest,
    @Schema(
            description = "Labels associated with the Activity",
