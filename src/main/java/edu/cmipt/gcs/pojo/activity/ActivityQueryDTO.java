...
public record ActivityQueryDTO(
    @Schema(description = "User Information",
            example = "Name:author123" + "/" +
                    "ID:1935328433259216897" + "/" +
    ...
    @Schema(description = "Repository ID",example = "1936351319541448705") @NotNull(groups = QueryGroup.class)
        String repositoryId,
    ...
    @Schema(
        ...
        List<String> labels,
    @Schema(description = "Assignees' names of the Activity", example = "[\"assignee1\", \"assignee2\"]")
